...
# JHC: this file was originally named "ros_robot_controller_sdk.py"
...
class Board:
    ...
    def __del__(self):
        self.port.close()              # JHC: make sure to free serial port
        ...
        while True:
            if self.enable_recv:
              try:                               
                ...
                pass                             # JHC: pyserial seems to get NoneType!
            else:
                time.sleep(0.01)
        self.port.close()
        print("END...")
